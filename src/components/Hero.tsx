          ...
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <h1 className="font-display font-black leading-none tracking-tight">
                <span className="block hero-name-shimmer" style={{ fontSize: "clamp(3.5rem,8vw,7rem)" }}>Puneeth</span>
                <span className="block pb-2 hero-name-raj" style={{ fontSize: "clamp(3.5rem,8vw,7rem)" }}>
                  Raj
                </span>
              </h1>
            </motion.div>
